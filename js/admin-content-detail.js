...
(function () {
        ...
        overlay.innerHTML = `
            <div class="detail-modal user360-modal" style="max-width:920px;width:96%;max-height:92vh;overflow:hidden;display:flex;flex-direction:column;">
                ...
                <div class="detail-modal-body" style="overflow-y:auto;padding:0;">
                    ...
                    <div style="padding:24px;border-bottom:1px solid #ECECEC;background:linear-gradient(135deg,#FAFAFC 0%, #F5F5F7 100%);">
                        <div style="display:flex;gap:18px;align-items:flex-start;">
                            ...
                            <div style="flex:1;min-width:0;">
                                ...
                                <div style="color:#8E8E8E;font-size:13px;margin-bottom:8px;cursor:pointer;" onclick="window.showUserDetail && window.showUserDetail('${safe(post.artistId)}')">
                            ...
                            <div style="display:flex;flex-direction:column;gap:6px;">
                                ${status !== 'removed'
                                    ? '<button class="btn-action btn-delete" id="post360RemoveBtn">Remove</button>'
                    ...
                    <div id="post360TabBody" style="padding:20px;min-height:240px;"></div>
                </div>
            </div>
        `;
    ...
    async function renderPostKpis(overlay, postId) {
        ...
        try {
            ...
            el.innerHTML =
                kpi('Times Ordered', orderCount, '#0EA5E9') +
                kpi('Generated Revenue', money(revenue), '#10B981') +
                kpi('Reports', reportsSnap.docs.length, '#ED4956');
        } catch (e) {
        ...
        overlay.innerHTML = `
            <div class="detail-modal user360-modal" style="max-width:880px;width:96%;max-height:92vh;overflow:hidden;display:flex;flex-direction:column;">
                ...
                <div class="detail-modal-body" style="overflow-y:auto;padding:0;">
                    ...
                    <div style="padding:24px;border-bottom:1px solid #ECECEC;background:linear-gradient(135deg,#FAFAFC 0%, #F5F5F7 100%);">
                        <div style="display:flex;gap:18px;align-items:flex-start;">
                            <div style="width:56px;height:56px;border-radius:50%;background:${statusColor}22;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
    ...
    async function renderReportKpis(overlay, report) {
        ...
        try {
            ...
            const byReporter = report.reporterId
                ...
                : { docs: [] };
            el.innerHTML =
                kpi('Reports on this post', others.docs.length, '#ED4956') +
                kpi('Filed by this user (total)', byReporter.docs.length, '#F59E0B') +
                kpi('Filed on', fmtDate(report.createdAt), '#6366F1');
        } catch (e) {
